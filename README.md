...
![sketch_1](assets/IMG_2134.jpg)
![sketch_2](assets/IMG_2136.jpg)
...
- The main idea for this project takes inspiration from "personal Knowledge database" project by the colombian artist and data scientist Santiago Ortiz in: https://intuitionanalytics.com/other/knowledgeDatabase/
- I acknowledge the use of ChatGPT (https://chat.openai.com/) to debug code and to explain code to me. Specifically with functions relative to Nodes design and behaviour: from lines 147 to 175; 324 to 332; 368 to 391; 523 to 547; 864 to 895.
